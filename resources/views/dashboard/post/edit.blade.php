        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form class="form-horizontal" action="{{ route('dashboard.posts.update', $post->id) }}" method="post"
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <textarea class="ckeditor form-control" name="detail" rows="6">{{ $post->detail }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            <img src="{{ isset($post->image) ? $post->image : "http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image"}}" alt=""/>
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                    <input type="checkbox" @if($post->status) checked @endif class="make-switch" value="{{ old('status', $post->status) }}" name="status">
                                </div>
                            </div>
                        </div>
